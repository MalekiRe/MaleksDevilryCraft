...
public class AutomotionRenderLayers extends RenderLayer {
    ...
    public static RenderLayer TRANSLUCENT_TEXTURED_COLORED = of("automotion:translucent_textured_colored", VertexFormats.POSITION_COLOR_TEXTURE, 7, 262144, true, true, RenderLayer.MultiPhaseParameters.builder().shadeModel(SMOOTH_SHADE_MODEL).transparency(RenderPhase.TRANSLUCENT_TRANSPARENCY).texture(MIPMAP_BLOCK_ATLAS_TEXTURE).target(TRANSLUCENT_TARGET).build(true));
