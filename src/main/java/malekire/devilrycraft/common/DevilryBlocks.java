...
public class DevilryBlocks {
    ...
    public static final Block SILVER_MOSS = new DevilryMoss(FabricBlockSettings.copy(Blocks.GRASS_BLOCK).ticksRandomly().sounds(BlockSoundGroup.GRASS).strength(0.6F, 0.5F));
